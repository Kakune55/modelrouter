...
func main() {
	...
	mux.HandleFunc("/admin/models/", adminHandler.Models)
	mux.HandleFunc("/admin/route-groups", adminHandler.RouteGroups)
	mux.HandleFunc("/admin/route-groups/", adminHandler.RouteGroups)
	mux.HandleFunc("/admin/client-keys", adminHandler.ClientKeys)
	mux.HandleFunc("/admin/client-keys/", adminHandler.ClientKeys)
	mux.HandleFunc("/admin/access-groups", adminHandler.AccessGroups)
	mux.HandleFunc("/admin/access-groups/", adminHandler.AccessGroups)
